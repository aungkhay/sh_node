...
PARTITION BY RANGE COLUMNS(createdAt) (
  PARTITION p202601 VALUES LESS THAN ('2026-01-01'),
  PARTITION p202602 VALUES LESS THAN ('2026-02-01'),
  PARTITION p202603 VALUES LESS THAN ('2026-03-01'),
  PARTITION p202604 VALUES LESS THAN ('2026-04-01'),
  PARTITION p202605 VALUES LESS THAN ('2026-05-01'),
  PARTITION p202606 VALUES LESS THAN ('2026-06-01'),
  PARTITION p202607 VALUES LESS THAN ('2026-07-01'),
  PARTITION p202608 VALUES LESS THAN ('2026-08-01'),
  PARTITION pmax    VALUES LESS THAN (MAXVALUE)
);


ALTER TABLE reward_records REMOVE PARTITIONING;
ALTER TABLE reward_records DROP PRIMARY KEY, ADD PRIMARY KEY (id);
```