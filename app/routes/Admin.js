...
class AdminRoute extends express.Router {
    constructor(app) {
        ...
        // Set Roles
        this.post('/users/:id/assign-roles', FormValidator.assign_roles(), middleware.isLoggedIn(), UserCtrl.ASSIGN_ROLES_TO_USER);
        ...
        this.post('/roles/:id/assign-permissions', FormValidator.assign_permissions(), middleware.isLoggedIn(), RoleCtrl.ASSIGN_PERMISSIONS_TO_ROLE);
    }
}
