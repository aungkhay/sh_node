...
class UserRoute extends express.Router {
    constructor(app) {
        ...
        this.post('/gift-voucher/:id/use', middleware.isLoggedIn, HomeCtrl.USE_GIFT_VOUCHER);
        ...
        // member state letter
        this.get('/member-state-letter', middleware.isLoggedIn, HomeCtrl.MEMBER_STATE_LETTER);
        this.post('/member-state-letter/use', middleware.isLoggedIn, HomeCtrl.USE_MEMBER_STATE_LETTER);
        this.post('/member-state-letter/buy', middleware.isLoggedIn, HomeCtrl.BUY_MEMBER_STATE_LETTER);
        // 
        ...
        this.get('/balance-tracking',  middleware.isLoggedIn, HomeCtrl.CASH_FLOW);
        // Masonic Package Routes
        this.get('/masonic-gift-packages', middleware.isLoggedIn, HomeCtrl.MASONIC_GIFT_PACKAGE);
        ...
        this.post('/policy-packages/:id/buy', FormValidator.buy_policy_package(), middleware.isLoggedIn, HomeCtrl.BUY_POLICY_PACKAGE);
        ...
        // Asset Distribution Plan Routes
        this.get('/asset-distribution-packages', middleware.isLoggedIn, HomeCtrl.ASSET_DISTRIBUTION_PACKAGE);
        this.post('/asset-distribution-packages/:id/buy', FormValidator.buy_asset_distribution_package(), middleware.isLoggedIn, HomeCtrl.BUY_ASSET_DISTRIBUTION_PACKAGE);
