...
class AssetDailyReleasePackage extends Model {
    toJSON() {
...
AssetDailyReleasePackage.init({
    ...
    sequelize,
    modelName: 'AssetDailyReleasePackage',
    tableName: 'asset_daily_release_packages',
    timestamps: true,
});

module.exports = AssetDailyReleasePackage;
