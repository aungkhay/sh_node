...
class SharingPlanPackage extends Model {
    toJSON() {
        ...
        if (attributes.price)
            ...
            if (attributes.price)
                attributes.price = Number(attributes.price);
        if (attributes.share_amount)
            attributes.share_amount = Number(attributes.share_amount);
        if (attributes.tag)
...
SharingPlanPackage.init({
    ...
    sequelize,
    modelName: 'SharingPlanPackage',
    tableName: 'sharing_plan_packages',
    timestamps: true,
});

module.exports = SharingPlanPackage;