...
class AssetDistributionPackage extends Model {
    toJSON() {
...
AssetDistributionPackage.init({
    ...
    sequelize,
    modelName: 'AssetDistributionPackage',
    tableName: 'asset_distribution_packages',
    timestamps: true,
});

module.exports = AssetDistributionPackage;
