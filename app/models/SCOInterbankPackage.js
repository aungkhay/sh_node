...
class SCOInterbankPackage extends Model {
    toJSON() {
...
SCOInterbankPackage.init({
    ...
    sequelize,
    modelName: 'SCOInterbankPackage',
    tableName: 'sco_interbank_packages',
    timestamps: true,
});

module.exports = SCOInterbankPackage;
