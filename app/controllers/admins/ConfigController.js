...
class Controller {
    ...
    UPDATE = async (req, res) => {
        try {
            ...
            if (['masonic_package_period', 'federal_reserve_gold_package_period', 'policy_package_period', 'federal_reserve_gold_package_get_free_time', 'shanghai_cooperation_period', 'gold_appreciation_package_period'].includes(config.type)) {
