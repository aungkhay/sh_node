...
const { GoldPrice, UserGoldPrice, User, Config, GoldInterest, db, GoldPackageHistory, GoldPackageBonuses, GoldPackageReturn, GoldPackageRepurchase } = require('../../models');
