        ...
        try {
            ...
            * =============================== */
            ...
            try {
                ...
                const verifiedPrice = Number(user.total_assets) * Number(aPackage.transfer_out_assets_rate) * 0.01; // 50
                const obj = {
                    relation: user.relation,
                    user_id: user.id,
                    package_id: aPackage.id,
