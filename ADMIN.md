...
// [POST] Add whitelist
const url = `${baseURL}/spring-festival-event/add-white-list`;
const data = {
...
// [GET] Whitelist
const url = `${baseURL}/spring-festival-event/white-list`;
const params = {
    page: 1,
    perPage: 10,
    startTime: '',
...
const data = {
    ...
    can_exchange_fragment: 1, // 是否可以兑换碎片
    description: '',
    status: 1, // 1-在售, 2-下架, 3-售罄
    can_new_registered_user_get_free: 1, // 新注册用户是否可以免费领取 default 0
}
...
// [POST] CREATE | UPDATE
const url = `${baseURL}/asset-distribution-packages/create`;
const url = `${baseURL}/asset-distribution-packages/${pkgID}/update`;
const data = {
    product_name: '',
    price: 0,
    period: 7,
...
// [POST] Upload Product Cover Image
const url = `${baseURL}/asset-distribution-packages/${packageId}/upload`;
const formData = new FormData();
formData.append('image', file, file.name.toLocaleLowerCase());
const config = {
    method: 'POST',
...
// [POST] CREATE | UPDATE
const url = `${baseURL}/asset-daily-release-packages/create`;
const url = `${baseURL}/asset-daily-release-packages/${pkgID}/update`;
const data = {
    product_name: '-',
    price: 20, // 认购金额
    period: 45, // 释放周期
...
// [POST] Upload Product Cover Image
const url = `${baseURL}/asset-daily-release-packages/${packageId}/upload`;
const formData = new FormData();
formData.append('image', file, file.name.toLocaleLowerCase());
const config = {
    method: 'POST',
...
// [POST] CREATE | UPDATE
const url = `${baseURL}/sco-interbank-packages/create`;
const url = `${baseURL}/sco-interbank-packages/${pkgID}/update`;
const data = {
    product_name: '-',
    price: 20, // 清验资金
    period: 45, // 清验期
...
// [POST] Upload Product Cover Image
const url = `${baseURL}/sco-interbank-packages/${packageId}/upload`;
const formData = new FormData();
formData.append('image', file, file.name.toLocaleLowerCase());
const config = {
    method: 'POST',
